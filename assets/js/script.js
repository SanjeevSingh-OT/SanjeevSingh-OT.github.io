...
(function ($) {
  ...
  if ($(".testimonials-wrap").length) {
    $(".testimonials-wrap").slick({
      ...
      slidesToShow: 1,
      slidesToScroll: 1,
      centerMode: false, // Changed to false for better centering
    ...
    $(".testimonials-wrap").on("init afterChange", function (event, slick) {
      $(this).find(".slick-slide").css("height", "");
      $(this).find(".slick-list").css("height", "auto");

      // Force recalculation of slider height
      setTimeout(() => {
    ...
    $(".testimonial-prev, .testimonial-next").css({
      opacity: "1",
      visibility: "visible"
    });
  }
